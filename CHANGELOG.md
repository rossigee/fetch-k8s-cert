...
- **CI/CD**: Added macOS universal PKG installer support
...
- **CI/CD**: Aligned pipeline with bucketsyncd patterns, unified build and release workflows
- **CI/CD**: Added Windows amd64 binary and MSI installer support via WiX Toolset
- **CI/CD**: Fixed dependency-review workflow license configuration conflict
...
- **CI/CD Fixes**: Resolved multiple workflow issues including invalid YAML parameters, missing gosec targets, and dependency installations for consistent builds.
